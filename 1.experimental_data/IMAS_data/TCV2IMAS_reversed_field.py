...
tcv_data = Dataset("./TCV_reversed_field.nc")
...
dd.ids_properties.comment = (
    "TCV-X21 dataset, for reversed field. Data has been processed over multiple pulses and time slices, and mapped onto the distance to separatrix at outboard midplane Rsep_omp (distance_separatrix_midplane in IMAS). Due to this process, langmuir probes array indices in IMAS don"
...
dd.ids_properties.source = "TCV_reversed_field.nc"
